本文只罗列出在 ES6 开发过程中相对实用的内容，而非一个高大全的文档，如果希望查阅详细的内容，可购买阮一峰老师所出版的 ES6 相关图书。
...
console.log(b);//undefined (b is not defined)
```
...
> 原文作者：TerryZ，地址：https://my.oschina.net/u/171860/blog/1794697
